...
public class SimpleBoxImpl implements BoxExternalAPI {
     ...
     *             box exception
     */
    public GetAuthTokenResponse authentication(String boxUName,
        ...
        GetTicketResponse getTicketResponse = this.getTicketMethod
        ...
        if (!BoxConstant.STATUS_GET_TICKET_OK.equals(getTicketResponse
            ...
            GetAuthTokenRequest getAuthTokenRequest = BoxRequestFactory
                    .createGetAuthTokenRequest(apiKey, getTicketResponse
                            .getTicket());
            GetAuthTokenResponse getAuthTokenResponse = this.getAuthTokenMethod
